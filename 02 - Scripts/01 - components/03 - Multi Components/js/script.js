...
var myGamePiece3; // Variável para armazenar a terceira peça
var myGamePiece4; // Variável para armazenar a quarta peça

function startGame() {
    myGameArea.start(); // Inicializa a área do jogo
    myGamePiece = new component(30, 30, "red", 10, 120); // Cria a primeira peça do jogo com tamanho e posição especificados
    myGamePiece2 = new component(50, 50, "blue", 300, 150); // Cria a segunda peça do jogo com tamanho e posição especificados
    myGamePiece3 = new component(20, 20, "green", 50, 50); // Cria a terceira peça do jogo com tamanho e posição especificados
    myGamePiece4 = new component(40, 40, "yellow", 200, 100); // Cria a quarta peça do jogo com tamanho e posição especificados
}
...
function updateGameArea() {
    ...
    myGamePiece.update(); // Atualiza e desenha a primeira peça do jogo na nova posição
    myGamePiece2.update(); // Atualiza e desenha a segunda peça do jogo na nova posição
    myGamePiece3.update(); // Atualiza e desenha a terceira peça do jogo na nova posição
    myGamePiece4.update(); // Atualiza e desenha a quarta peça do jogo na nova posição
}
