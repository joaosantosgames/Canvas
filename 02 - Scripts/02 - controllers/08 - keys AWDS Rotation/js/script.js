...
function updateGameArea() {
    ...
    if (myGameArea.keys && myGameArea.keys[87]) {myGamePiece.speed = 1; } // Tecla 'W' para cima
    if (myGameArea.keys && myGameArea.keys[83]) {myGamePiece.speed = -1; } // Tecla 'S' para baixo
